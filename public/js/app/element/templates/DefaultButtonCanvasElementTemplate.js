...
(function() {
  ...
  define(['framework/Template'], function(Template) {
    ...
    return PrimaryButtonElementTemplate = (function(_super) {
      ...
      PrimaryButtonElementTemplate.prototype.template = "<div class=\"element primary-button btn\" style=\"width:{{width}};font-size:{{fontSize}};height:{{height}};top:{{y}};left:{{x}};z-index:{{z-index}};\">{{text}}</div>";
